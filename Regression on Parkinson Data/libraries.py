...
#%% Plotting Functions :
    ...
    def hist(self, y, A, y_test, A_test, mean , var, title ):
        ...
        plt.hist(y_tr-y_est_tr, bins=100, alpha=0.7, color = 'darkviolet', label = "training")
        plt.hist(y_test-y_est_test, bins=100, alpha=0.7, color = 'forestgreen', label = "test")
    ...
    def hist_plus_val(self, y, A, y_test, A_test, y_val, A_val, mean , var, title ):
        ...
        plt.hist(y_tr-y_est_tr, bins=100, alpha=0.7, label = "training", color = 'darkviolet')
        plt.hist(y_test-y_est_test, bins=100, alpha=0.7, label = "test", color='forestgreen')
        plt.hist(y_val-y_est_val, bins=100, alpha=0.7, label="validation", color='gold')
